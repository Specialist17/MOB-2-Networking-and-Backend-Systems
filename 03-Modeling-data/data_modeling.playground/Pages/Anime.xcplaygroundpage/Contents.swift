...
struct Anime {
    ...
    init(title: String, thumbnail: URL, id: String, data: [Anime]) {
        self.title = title
...
extension Anime: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let animes = try dataContainer.decode([Anime].self, forKey: .data)
        
        let container = try dataContainer.nestedContainer(keyedBy: Keys.self, forKey: Anime.DataKeys) // defining our (keyed) container
        ...
        self.init(title: title, thumbnail: thumbnail, id: id, data: animes)
    }
}
